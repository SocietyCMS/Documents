...
class ObjectTransformer extends Fractal\TransformerAbstract
{
    ...
    protected function fileTransformer($file)
    {
        return [
            ...
            'objectSize' => (int)$file->fileSize,
            'fq_path' => $file->getFQPath(),
            'fq_uid' => $file->getFQUid(),
            'ns_path' => $file->getNSPath(),
            'downloadUrl' => apiRoute('v1', 'api.documents.file.download',
                ['pool_id' => $file->pool_uid, 'id' => $file->uid]),
